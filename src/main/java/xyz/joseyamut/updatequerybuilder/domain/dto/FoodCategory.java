...
public class FoodCategory {
    ...
    @JsonProperty("id")
    @NotNull(message = "Provide the {id} of the category to be updated.", groups = {PatchFoodCategoryGroup.class})
    @Min(value = 1, message = "Invalid value of {id} field.", groups = {PatchFoodCategoryGroup.class})
    private Integer id;

    @JsonProperty("name")
    @NotBlank(message = "Field {name} must not be blank.", groups = {PostFoodCategoryGroup.class})
    @Size(min = 3, max = 64, message = "Value of {name} field must be at least 3 chars and not more than 64 chars.", groups = {PostFoodCategoryGroup.class, PatchFoodCategoryGroup.class})
    private String name;
    ...
    @Min(value = 1, message = "Value of {group_id} field cannot be less than 1.", groups = {PostFoodCategoryGroup.class, PatchFoodCategoryGroup.class})
    ...
    @NotBlank(message = "Field {updated_by} must not be blank.", groups = {PatchFoodCategoryGroup.class})
    @Size(min = 3, max = 48, message = "Value of {updated_by} field must be at least 3 chars and not more than 254 chars.", groups = {PatchFoodCategoryGroup.class})
    ...
    @NotNull(message = "Field {is_active} must be either true or false.", groups = {PostFoodCategoryGroup.class})
